...
using Distributions
export RandomStrainDistribution, RandomDislocation, RandomDislocationDistribution
...
* `burgers_vectors::RBVD`: the distribution of random Burger's vectors and locations in the `axes`
"""
...
"""
RandomDislocationDistribution(; axes, concentration, vector_diff, rand_num_dis, burgers_vectors ) = RandomDislocationDistribution( axes, concentration, vector_diff, rand_num_dis, burgers_vectors )
